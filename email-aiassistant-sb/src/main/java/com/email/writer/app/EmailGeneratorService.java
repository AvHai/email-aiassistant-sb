...
// //         toneInstruction = "Write a professional reply.";
// //     } else {
// //         switch (tone.toLowerCase()) {
// //             case "formal" -> toneInstruction = "Write a formal and professional reply.";
// //             case "friendly" -> toneInstruction = "Write a warm, friendly, but still professional reply.";
// //             case "concise" -> toneInstruction = "Write a very concise and to-the-point professional reply.";
// //             default -> toneInstruction = "Write a professional reply using a " + tone + " tone.";
// //         }
// //     }

// //     prompt.append(toneInstruction).append("\n\n");
// //     prompt.append("You are replying to the latest email in the following email thread.\n")
// //           .append("Do NOT generate a subject line.\n")
// //           .append("Only output the reply body, not any headers like From/To/Subject.\n\n");
...
// //     // 3. Thread vs legacy single email
// //     if (emailRequest.getMessages() != null && !emailRequest.getMessages().isEmpty()) {
// //         prompt.append("Email thread:\n");
// //         for (EmailMessageDTO msg : emailRequest.getMessages()) {
...
// //             }
// //             if (msg.getSentAt() != null && !msg.getSentAt().isBlank()) {
// //                 prompt.append("Sent at: ").append(msg.getSentAt()).append("\n");
// //             }
// //             prompt.append("Body:\n")
...
// //             Reply as the recipient of the last email in this thread.
// //             Keep the response factual and aligned with the thread.If certain information is missing or unclear, feel free to include placeholders
// //             like [Insert date], [Add details], or [Name/Title] so the user can fill them later.
// //             """);
...
//               either keep the wording general OR use a short placeholder like [date], [link], or [file name].
